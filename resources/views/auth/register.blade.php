...
<head>
    ...
    <style>
        ...
        body {
            /* ... kode sebelumnya ... */
            overflow-y: auto;   /* tambahkan ini agar bisa scroll */
        }
    </style>
</head>
<body>
...
<div class="card">
    ...
    <p class="text-center text-xs font-semibold uppercase mb-2" style="color:#C9A84C; letter-spacing:0.25em;">
        Bergabung
    </p>
    <h1 class="text-center mb-1" style="font-family:'Cormorant Garamond',serif; font-size:32px; font-weight:300; color:#F5F0E8;">
        Buat <em style="color:#E8CC80; font-style:italic;">Akun Baru</em>
    </h1>
    <p class="text-center text-xs mb-7" style="color:#BFB99E; letter-spacing:0.05em;">
        Daftarkan diri sebagai peminjam
    </p>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mb-4">
            <label class="block mb-2" style="font-size:10px; font-weight:600; letter-spacing:0.15em; text-transform:uppercase; color:#BFB99E;">
                Nama Lengkap
            </label>
            <input type="text" name="name" value="{{ old('name') }}" required autofocus
                placeholder="Nama Anda" class="field-style"
        ...
        <div class="mb-4">
            ...
            <input type="password" name="password" required
                placeholder="Min. 8 karakter" class="field-style"
                onfocus="this.style.borderColor='rgba(201,168,76,0.6)'; this.style.background='rgba(201,168,76,0.04)'"
                onblur="this.style.borderColor='rgba(201,168,76,0.2)'; this.style.background='rgba(255,255,255,0.04)'">
        ...
        <div class="mb-6">
            ...
            <input type="password" name="password_confirmation" required
                placeholder="Ulangi kata sandi" class="field-style"
                onfocus="this.style.borderColor='rgba(201,168,76,0.6)'; this.style.background='rgba(201,168,76,0.04)'"
                onblur="this.style.borderColor='rgba(201,168,76,0.2)'; this.style.background='rgba(255,255,255,0.04)'">
        ...
        <p class="text-center mt-5" style="font-size:11px; color:#BFB99E; letter-spacing:0.05em;">
            Sudah punya akun?
            <a href="{{ route('login') }}" style="color:#E8CC80; text-decoration:none; font-weight:500;">
                Masuk di sini
            </a>
        </p>
    </form>
